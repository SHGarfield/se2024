	...
	<view class="list-section">
		<scroll-view class="scroll-list" scroll-y :refresher-enabled="true" @refresherrefresh="handleRefresh"
			...
			<view class="list-content">
				...
				<text class="item-title">{{item.title}}标题</text>
				<text
					class="item-content">{{item.content}}内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内容内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到内容内容内容呢欧冠那送后哦昂欧的分工i经济Odis机构i收到</text>
			</view>
		</scroll-view>
		<view class="bottom-bar">
			<button class="save-route-button">保存路线</button>
		</view>
	</view>
</template>
